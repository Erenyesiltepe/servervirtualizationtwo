...
const server_id = document.getElementsByName("server_id")[0].getAttribute("content") as string
const extension_id = document.getElementsByName("extension_id")[0].getAttribute("content") as string
const csrf = document.getElementsByName("csrf-token")[0].getAttribute("content") as string
